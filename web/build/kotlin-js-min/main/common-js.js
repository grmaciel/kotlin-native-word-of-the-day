(function (_, Kotlin) {
  ...
  DateTime.$metadata$ = {kind: Kind_CLASS, simpleName: 'DateTime', interfaces: []};
  function WordOfTheDay(day, word, description) {
    this.day = day;
    this.word = word;
    this.description = description;
  }
  WordOfTheDay.$metadata$ = {kind: Kind_CLASS, simpleName: 'WordOfTheDay', interfaces: []};
  ...
  WordOfTheDayInMemoryRepository.$metadata$ = {kind: Kind_CLASS, simpleName: 'WordOfTheDayInMemoryRepository', interfaces: [WordRepository]};
  function WordRepository() {
  }
  WordRepository.$metadata$ = {kind: Kind_INTERFACE, simpleName: 'WordRepository', interfaces: []};
  ...
  WordUseCase.$metadata$ = {kind: Kind_CLASS, simpleName: 'WordUseCase', interfaces: []};
  ...
  WordOfTheDayViewModel.$metadata$ = {kind: Kind_CLASS, simpleName: 'WordOfTheDayViewModel', interfaces: []};
